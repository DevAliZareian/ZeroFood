...
export default function Map() {
  return (
    <div className="w-full h-screen flex items-center justify-center z-50 inset-0 fixed bg-black bg-opacity-30">
      <div className="w-[90vw] max-w-[640px] max-h-[90vh] overflow-hidden shadow z-50 bg-white rounded-[7px]">
        <div className="relative w-full h-[56px] pl-[56px] flex items-center justify-between p-[12px]">
          <button className="h-[56px] w-[56px] outline-none cursor-pointer">
        ...
        <div className="p-[12px]">
          <p className="text-[1.5rem] font-bold">انتخاب آدرس</p>
          <p className="text-zinc-600">برای مشاهده مناسب‌ترین پیشنهادها به شما، ابتدا موقعیتتان را مشخص کنید.</p>
        </div>
        <section className="relative">
          <NeshanMap
            ...
            traffic={false}
            poi={false}
            mapKey="web.2fb46997c9da4fb5b773728f291bf44e"
          ></NeshanMap>
        </section>
        <form className="mt-0">
          <div className="p-[12px]">
