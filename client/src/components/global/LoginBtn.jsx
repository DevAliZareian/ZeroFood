...
export default function LoginBtn() {
  ...
  const user = useGetQueryData("user");
    ...
    <>
      {user ? (
        <button
          ...
          className="w-auto min-w-[6.6875rem] p-2 h-12 inline-flex items-center justify-center text-center text-white bg-green-500 border-none cursor-pointer duration-[0.3s] overflow-hidden rounded-[0.375rem] text-[1.125rem] font-bold"
        >
          <span className="text-[1rem] font-bold">حساب کاربری</span>
        </button>
      ) : (
        <div className="flex items-center justify-center gap-2">
          <svg width="24" height="26" viewBox="0 0 24 26" fill="#3A3D42" xmlns="http://www.w3.org/2000/svg">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
          ...
          <button
            ...
            className="w-auto min-w-[6.6875rem] p-2 h-12 inline-flex items-center justify-center text-center text-white bg-green-500 border-none cursor-pointer duration-[0.3s] overflow-hidden rounded-[0.375rem] text-[1.125rem] font-bold"
          >
            <span className="mr-0 ml-[3px] text-[1rem] font-bold m-0 p-0">ورود</span>
            <span className="font-normal mr-0 ml-[3px]">یا</span>
            <span className="mr-0 ml-0 text-[1rem] font-bold m-0 p-0">عضویت</span>
          </button>
        </div>
      )}
    </>
